 ...
 * @property {Promise.<string>} definition - A url with YAML file which describe external resources
 * @property {function} handleExternalModules - A stub only target for jest unit test
 */
